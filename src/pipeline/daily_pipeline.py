...
from src.modeling.predict_next_day import main as predict_next_day_main
...
def main() -> None:
    ...
    print("\n[1/8] Ingesting oil prices...")
    oil_price_ingest_main()

    print("\n[2/8] Ingesting RSS articles...")
    rss_ingest_main()

    print("\n[3/8] Processing articles...")
    article_processor_main()

    print("\n[4/8] Aggregating daily news...")
    aggregate_daily_news_main()

    print("\n[5/8] Building model features...")
    build_model_features()

    print("\n[6/8] Creating next-day price and direction prediction...")
    predict_next_day_main()

    print("\n[7/8] Checking retraining need...")
    retraining_check_main()

    print("\n[8/8] Auto-retraining if needed...")
    auto_retrain()
