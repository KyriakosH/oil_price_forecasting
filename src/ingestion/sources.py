...
API_SOURCES = [
    ...
    },
    {
        ...
        "domain_name": "gdeltproject.org",
        "topic_focus": "news,oil_market,geopolitics,economy,supply,demand",
    },
    {
        "source_name": "GDELT Sanctions Energy News",
        "source_type": "api",
        "base_url": "https://api.gdeltproject.org",
        "feed_url": (
            "https://api.gdeltproject.org/api/v2/doc/doc"
            "?query=sanctions%20energy%20oil%20russia%20iran"
            "&mode=ArtList"
            "&format=json"
            "&maxrecords=50"
            "&sort=HybridRel"
        ...
        "domain_name": "gdeltproject.org",
        "topic_focus": "news,sanctions,energy,oil_market,geopolitics",
    },
    {
        "source_name": "GDELT OPEC News",
        "source_type": "api",
        "base_url": "https://api.gdeltproject.org",
        "feed_url": (
            "https://api.gdeltproject.org/api/v2/doc/doc"
            "?query=opec%20OR%20opec%2B%20OR%20oil%20production"
            "&mode=ArtList"
            "&format=json"
            "&maxrecords=50"
            "&sort=HybridRel"
        ...
        "domain_name": "gdeltproject.org",
        "topic_focus": "news,opec,supply,oil_market,production",
    },
    {
