...
def train_model_b() -> None:
    ...
    run_ids["LinearRegression"] = insert_model_run(
        ...
        "Final Model B: price + sentiment linear regression baseline.",
    )
    run_ids["QuantileRegression"] = insert_model_run(
        "ModelB_QuantileRegression",
        "final",
        "BRENT",
        train_df,
        val_df,
        ...
        "Final Model B: price + sentiment quantile regression.",
    )
    run_ids["RandomForest"] = insert_model_run(
        ...
        "Final Model B: price + sentiment random forest.",
    )
    run_ids["XGBoost"] = insert_model_run(
        ...
        "Final Model B: price + sentiment XGBoost.",
    )
    run_ids["Ensemble"] = insert_model_run(
        ...
        "Final Model B: simple average of LR, QR, RF, XGB with sentiment.",
    )
    ...
    print("\n=== Tomorrow Prediction Summary (Model B) ===")
